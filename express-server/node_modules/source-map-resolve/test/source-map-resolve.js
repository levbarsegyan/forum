...
var map = {
  ...
  sourceRoot: {
    ...
    sources:    ["foo.js", "lib/bar.js", "../vendor/dom.js", "/version.js", "
    names:      []
  },
  sourceRootNoSlash: {
    mappings:   "AAAA",
  ...
  sourcesContent: {
    ...
    sourceRoot:     "/static/js/app/",
    sources:        ["foo.js", "lib/bar.js", "../vendor/dom.js", "/version.js", "
    sourcesContent: ["foo.js", "lib/bar.js", "../vendor/dom.js", "/version.js", "
    names:          []
  },
  mixed: {
    mappings:       "AAAA",
    sources:        ["foo.js", "lib/bar.js", "../vendor/dom.js", "/version.js", "
    sourcesContent: ["foo.js", null        , null              , "/version.js", "
    names:          []
  },
  noSources: {
    mappings: "",
  ...
  return function(t) {
    ...
    method(code.absolute, codeUrl, readSimple, function(error, result) {
      ...
      t.deepEqual(result, {
        ...
        sourcesRelativeTo: "https:
        map:               map.simple,
        sourcesResolved:   ["https:
        sourcesContent:    ["https:
      }, "absolute")
      isAsync()
    })
    ...
    method(code.fileRelative, codeUrl, readMap(map.simple), function(error, result) {
      t.error(error)
      t.deepEqual(result.sourcesResolved, ["http:
      t.deepEqual(result.sourcesContent,  ["http:
      isAsync()
    })
